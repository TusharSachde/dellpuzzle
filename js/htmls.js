...
hometemplate += "                    <input type=\"text\" class=\"form-control\" placeholder=\"City\" ng-model=\"submit.city\">";
hometemplate += "                    <div class=\"text-center\">";
hometemplate += "                        <button class=\"btn btn-default btn-dell\" type=\"submit\" ng-hide=\"submit.name=='' || submit.email=='' || submit.phone=='' || !submit.email || !submit.city\" ng-click=\"register(submit);\">Submit<\/button>";
hometemplate += "                    <\/div>";
hometemplate += "                <\/form>";
hometemplate += "            <\/div>";
hometemplate += "        <\/div>";
